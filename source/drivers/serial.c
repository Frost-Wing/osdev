...
void probe_serial() {
    ...
    if (!init_serial(COM1))
        select = COM1;
    else if (!init_serial(COM2))
        select = COM2;
    else if (!init_serial(COM3))
        select = COM3;
    else if (!init_serial(COM4))
        select = COM4;
    else if (!init_serial(COM5))
        select = COM5;
    else if (!init_serial(COM6))
        select = COM6;
    else if (!init_serial(COM7))
        select = COM7;
    else if (!init_serial(COM8))
        select = COM8;
    else {
