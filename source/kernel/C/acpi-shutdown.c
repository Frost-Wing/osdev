...
static inline uint8 parse_integer(uint8 *s5_addr, uint64 *value) {
    ...
    switch (operation) {
        ...
        case 0xE: // QWordConst
            *value = s5_addr[0] | ((uint64)s5_addr[1] << 8) | ((uint64)s5_addr[2] << 16) | ((uint64)s5_addr[3] << 24) | ((uint64)s5_addr[4] << 32) | ((uint64)s5_addr[5] << 40) | ((uint64)s5_addr[6] << 48) | ((uint64)s5_addr[7] << 56);
