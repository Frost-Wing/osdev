...
#define __tg_real_complex(fun, x) (__RETCAST(x)(          \
    __FLTCX(x) ? c##fun##f(x) : __DBLCX(x) ? c##fun(x)    \
...
#define __tg_real_remquo(x, y, z) (__RETCAST_2(x, y)(                              \
    __FLT(x) && __FLT(y) ? remquof(x, y, z) : __LDBL((x) + (y)) ? remquol(x, y, z) \
                                                                : remquo(x, y, z)))

#define __tg_real_fma(x, y, z) (__RETCAST_3(x, y, z)(                                          \
    __FLT(x) && __FLT(y) && __FLT(z) ? fmaf(x, y, z) : __LDBL((x) + (y) + (z)) ? fmal(x, y, z) \
                                                                               : fma(x, y, z)))

#define __tg_real_complex_pow(x, y) (__RETCAST_2(x, y)(                                             \
    __FLTCX((x) + (y)) && __IS_FP(x) && __IS_FP(y) ? cpowf(x, y) : __FLTCX((x) + (y)) ? cpow(x, y)  \
...
#define __tg_real_complex_fabs(x) (__RETCAST_REAL(x)( \
    __FLTCX(x) ? cabsf(x) : __DBLCX(x) ? cabs(x)      \
                        : __LDBLCX(x)  ? cabsl(x)     \
                        : __FLT(x)     ? fabsf(x)     \
                        : __LDBL(x)    ? fabsl(x)     \
                                       : fabs(x)))
